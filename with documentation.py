...
class KeyLoggerThread:
    ...
    def stop(self):
        """
        Stops the key logging process and terminates the listener.
        """
...
if __name__ == "__main__":
    ...
    def signal_handler(sig, frame):
        """
        Handles termination signals (SIGINT and SIGTERM) to properly shut down the keylogger.
        """
        print("\nShutting down...")
        keylogger.stop()
        thread.join()
    ...
    signal.signal(signal.SIGTERM, signal_handler)  # Handles forced shutdown
